...
namespace WebClient.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                return View("~/Views/Departments/View.cshtml");
            }
        ...
        public IActionResult LoadDepart()
        {
            ...
            {
                var readTask = result.Content.ReadAsAsync<List<Departments>>();
                readTask.Wait();
        ...
        public IActionResult GetById(int Id)
        {
            ...
            if (result.IsSuccessStatusCode)
            {
                ...
                departments = JsonConvert.DeserializeObject<Departments>(json);
            }
            else
            {
        ...
        public IActionResult InsertOrUpdate(Departments departments, int id)
        {
            try
            {
